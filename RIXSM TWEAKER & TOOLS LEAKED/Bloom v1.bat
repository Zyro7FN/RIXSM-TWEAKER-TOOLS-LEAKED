...
::
::YAwzoRdxOk+EWAjk
::fBw5plQjdCyDJGyX8VAjFAldXxyMAE+1EbsQ5+n//Na17EQeW4I=
...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFAldXxyMAE+/Fb4I5/jHzcaojWBdYrNxfZfeug==
::YB416Ek+ZW8=
::
::
...
echo.       %f%%f%
echo.       %f%%w%                                                                                                                  %f%
echo.       %f%%w%                      %f%[1]%w% Activate Bloom Pack                  %f%[2]%w% Disable Bloom Pack                               %f%        
echo.       %f%%w%                                                                                                                  %f%
echo.       %f%%w%                                                                                                                  %f%
